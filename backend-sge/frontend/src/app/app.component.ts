...
>>>>>>> 531e83657957e0fbcd568a69e7bcfb92523e09b9
  ...
  title: any;
    ...
    ngOnInit() {
        ...
        this.menuService.itens = [
            ...
            { label: 'Home', icon: 'home', routerLink: ['/eventos/evento-listagem'] },
            { label: 'Usuários', icon: 'perm_identity', routerLink:['/usuarios/listagem'] }
        ];
    }
